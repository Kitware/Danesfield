...
def main(config_fpath):
    ...
    # This mesh can be generated by merging all the meshes reconstructed at the previous steps
    #   - occlusion_mesh: is the filename where we want to generate this occlusion file
    #   - meshes_directory: is the directory which contains all the meshes reconstructed at the previous steps
    occlusion_mesh = "xxxx.obj"
    cmd_args = [meshes_directory, occlusion_mesh]    # we can add the option "--check_offsets" if the offsets are still encoded inside the obj file
