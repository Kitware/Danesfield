...
from tasks.seval import Evaluator
import argparse
import json
...
parser.add_argument('rgbpath', help='3-channel 8-bit RGB image path')
parser.add_argument('dsmpath', help='1-channel float DSM file path')
parser.add_argument('dtmpath', help='1-channel float DSM file path')
parser.add_argument('msipath', help='1-channel float DSM file path')
