...
class Distort1:
    ...
    def __call__(self, img, mask=None):
        if random.random() < self.prob:
            ...
            #  map_x, map_y =
            # cv2.initUndistortRectifyMap(intrinsics, dist_coeffs, None, None,
...
class RandomHueSaturationValue:
    def __init__(self, hue_shift_limit=(-20, 20), sat_shift_limit=(-35, 35),
                 val_shift_limit=(-35, 35), prob=0.5):
