...
def sample_and_group(npoint, radius, nsample, xyz, points, knn=False, use_xyz=True):
    ...
    Input:
        ...
        use_xyz: bool, if True concat XYZ with local point features, otherwise just use point features  # noqa: E501
    Output:
...
def sample_and_group_all(xyz, points, use_xyz=True):
    ...
    new_xyz = tf.constant(np.tile(np.array([0, 0, 0]).reshape(
        (1, 1, 3)), (batch_size, 1, 1)), dtype=tf.float32)  # (batch_size, 1, 3)
...
def pointnet_sa_module(xyz, points, npoint, radius, nsample, mlp, mlp2, group_all, is_training, bn_decay, scope, bn=True, pooling='max', knn=False, use_xyz=True, use_nchw=False):  # noqa: E501
    ''' PointNet Set Abstraction (SA) Module
        Input:
            ...
            use_xyz: bool, if True concat XYZ with local point features, otherwise just use point features  # noqa: E501
            use_nchw: bool, if True, use NCHW data format for conv2d, which is usually faster than NHWC format  # noqa: E501
        Return:
            new_xyz: (batch_size, npoint, 3) TF tensor
...
def pointnet_sa_module_msg(xyz, points, npoint, radius_list, nsample_list, mlp_list, is_training, bn_decay, scope, bn=True, use_xyz=True, use_nchw=False):  # noqa: E501
