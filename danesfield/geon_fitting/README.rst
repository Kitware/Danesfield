...
The shared object files needed for this tool are provided by the `core3d-tf_ops` conda package from kitware-danesfield-build.  However, if you still wish to compile the necessary files ..
