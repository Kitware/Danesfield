...
gpu_set = ['3']
#parameter_set = [' --shift --da ', ' --da ', ' ', ' --da --shift --flip ', ' --da --shift --scale ', ' --da --shift --flip --scale ']# , ' --da '
...
for idx, parameter in enumerate(parameter_set):
    ...
    command = 'python test_roof_segmentation.py {}  --gpu_id={}'.format(parameter, gpu_set[idx%number_gpu])
